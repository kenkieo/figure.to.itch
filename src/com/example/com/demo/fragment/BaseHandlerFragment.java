...
public abstract class BaseHandlerFragment extends BaseFragment{
	...
	private static class MyHandler extends Handler{
		...
		private WeakReference<BaseHandlerFragment> wr;
		
		public MyHandler(BaseHandlerFragment t) {
			wr = new WeakReference<BaseHandlerFragment>(t);
		}
	...
	@Override
	protected final void releaseRes() {
	 ...
	 * 释放资源 widget = 2
	 */
	protected abstract void releaseHandlerFragment();
