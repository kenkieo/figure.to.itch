...
import com.example.com.demo.widget.mode.ModeFrameFirst;
...
public class StyleSecondFragment extends StyleContentFrament implements OnModeFrameAction{
	...
	private ModeFrameFirst 	mModeFrame;
	...
	protected void initViews(View convertView) {
		...
		mModeFrame = (ModeFrameFirst) convertView.findViewById(R.id.layout_frame);
	}
	...
	public void onLayoutChange() {
		float degrees = 360.0f / Constants.INIT_NUM_MODE_2;
		for (int i = 0; i < Constants.INIT_NUM_MODE_2; i++) {
