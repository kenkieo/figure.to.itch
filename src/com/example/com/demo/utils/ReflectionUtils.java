...
public class ReflectionUtils {
	...
	public static Object getSystemService(Context context, String name) throws SecurityException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException, ClassNotFoundException, InstantiationException{
		Object service = getStaticField(Context.class.getName(), name);
		return context.getSystemService(service.toString());
	}
	
	public static Object getStaticField(String clsName, String field) throws SecurityException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException, ClassNotFoundException, InstantiationException{
		Class<?> cls = Class.forName(clsName);
		Field fd = cls.getDeclaredField(field);
		return fd.get(null);
	}
	
	public static int getStaticFieldInt(String clsName, String field) throws SecurityException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException, ClassNotFoundException, InstantiationException{
		Class<?> cls = Class.forName(clsName);
		Field fd = cls.getDeclaredField(field);
		return fd.getInt(null);
	}
